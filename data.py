...
def build_clevr(split, resolution=(128, 128), shuffle=False, max_n_objects=10,
  ...
  if split == "train" or split == "train_eval":
    ds = tfds.load("clevr:3.1.0", split="train", shuffle_files=shuffle, data_dir='/home/data2/objectcentric_video/clevr')
    if split == "train":
    ...
    ds = tfds.load("clevr:3.1.0", split=split, shuffle_files=shuffle, data_dir='/home/data2/objectcentric_video/clevr')
